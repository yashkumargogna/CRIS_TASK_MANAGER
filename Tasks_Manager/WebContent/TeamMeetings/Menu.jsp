...
<html>
<head><title>TEAM MEETINGS REPORT</title>
...
<jsp:useBean id="IcmsadminFilter" class="IcmsadminFilter" scope="request"></jsp:useBean>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="<%=request.getContextPath()%>/appImages/curve-head-bg-cor.jpg">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="50%" align="center"><font color="#ffff00">ICMS TEAM MEETING REPORT</font></td>
									</tr>
								</table>
							</td>
														...
														<div align="left">
															<div align="center">
																<TABLE width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#d7d7d7" style="border-collapse: collapse;">
																	<TR>
																		<TD><ul class="topnav">
																				<li><div class="topnav"><a href="IcmsadminServlet?action=MicsUtilites&subAction=TeamMeeting&event=addMain"; title="This is for Meetings Entry Form !" tabindex="1">ADD MEETING</a></div></li>
																				...
																				<li><div class="topnav"><a href="IcmsadminServlet?action=MicsUtilites&subAction=MeetingReport&event=mReportMain"; title="This is for Meetings Report Form !" tabindex="3">MEETING REPORT</a></div></li>
																			</ul>
																		</TD>
																	</TR>
																</TABLE>
