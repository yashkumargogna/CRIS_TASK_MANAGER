...
* 5724-i63, 5724-H88(C) COPYRIGHT International Business Machines      *
*  Corp., 1997, 2005  All Rights Reserved * Licensed Materials -       *
*  Property of IBM  US Government Users Restricted Rights - Use,       *
...
function whatObjectOn(e) {
    ...
    if (obj != null) {
        ...
        } else if ((obj.parentNode.parentNode.tagName == "LI") && (obj.tagName == "A") && (document.getElementById("fieldHelpPortlet") != null)) {
                //obj.style.color = "black";
...
document.write("<div id='progress' style=\"position:absolute;display:none;top:200;left:200;border: 1px black solid;padding:3px 3px 3px 3px;background-color:#FFFFFF;font-family: sans-serif;font-size: 80%\"><NOBR><img src='images/appInstall_animated.gif' align='texttop' alt='"+pleaseWait+"'>" + pleaseWait + "</NOBR></div>");




function floatHelpPortlet(e) {
    if (document.getElementById("wasHelpPortletPos") != null) {
        if (isDom) {
            currentPos = parseInt(document.getElementById("wasHelpPortletPos").style.top);
            if (currentPos != document.body.scrollTop) {
                document.getElementById("wasHelpPortletPos").style.visibility = "hidden";
            }
			//WSC Console: needed for Federation
            document.getElementById("wasHelpPortletPos").style.top = document.body.scrollTop + federationAdder;
            if (document.body.scrollTop > 20) {
                document.getElementById("wasHelpPortletPos").style.position = "relative";
            }
            setTimeout('document.getElementById("wasHelpPortletPos").style.visibility = "visible"',750);

        } else {
            currentPos = document.getElementById("wasHelpPortletPos").style.pixelTop;
            if (currentPos != document.body.scrollTop) {
                document.getElementById("wasHelpPortletPos").style.visibility = "hidden";
            ...
            //WSC Console: needed for Federation
            document.getElementById("wasHelpPortletPos").style.pixelTop = document.body.scrollTop + federationAdder;
...
function showAlt(e) {
        ...
        for (q=0;q<labelList.length;q++) {
            if (labelList[q].getAttribute("htmlFor") != "") {
...
function determinePortletPrefs(objectId) {
    if (document.getElementById(objectId) != null) {
           if (objectId == "com_ibm_ws_inlineMessages") {
               ...
               state = setState.substring(0,setState.indexOf("+endTransmission"));
           }
...
function showHideSection(objectId) {
    if (document.getElementById(objectId) != null) {
       ...
       if (objectId == "com_ibm_ws_inlineMessages") {
           ...
           if (objectId == "com_ibm_ws_prefsTable") {
...
{
	//alert(item+"---"+document.getElementById("child_"+item));
	//alert(item+"---"+document.getElementById("img_"+item));
	if(document.getElementById("child_"+item) == null) alert(item+"---"+document.getElementById("child_"+item));
	if(document.getElementById("img_"+item) == null) alert(item+"---"+document.getElementById("img_"+item));
        ...
        if (document.getElementById(objectId).style.display == "none") {
            if (document.getElementById(objectId+"Img")) {
            	...
            	if ( objectId == "wasHelpPortlet" && federationAdder == "10" ) {
	            	document.getElementById(objectId+"Img").src = "images/IRU_title_minimize.gif";
            	} else {
            ...
            if (document.getElementById(objectId+"Img")) {
            	//WSC Conosle Federation
            	if ( objectId == "wasHelpPortlet" && federationAdder == "10" ) {
	            	document.getElementById(objectId+"Img").src = "images/IRU_title_restore.gif";
            	} else {
